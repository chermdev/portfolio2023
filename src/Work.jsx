...
function Work() {
    ...
    return (
        <section id="work" className="flex justify-center pt-16 sm:pt-20">
            <div className='w-[var(--max-page-width)] max-w-[var(--max-section-width)] m-auto pt-5 flex justify-center items-center flex-col xl:flex-row xl:items-start gap-10 xl:gap-0'>
