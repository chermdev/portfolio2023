...
function ContactForm() {
    ...
    return (
        <form action="#" className="space-y-8">
            ...
            <button type="submit" className="py-1 px-4 text-md font-medium shadow-sm text-center rounded-full text-teal-800 bg-teal-300  hover:text-white hover:bg-teal-800 dark:text-sky-900 dark:bg-sky-400 dark:hover:text-white  dark:hover:bg-blue-800">{contactButtonText}</button>
        </form>
    )
}
...
function Footer() {
    return (
        <footer id="footer" className="bg-gradient-to-b from-teal-400 to-teal-600 text-white dark: dark:from-sky-500 dark:to-blue-500">
            <div id="contact-me" className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            ...
            <div id="social" className="flex gap-4 py-6 items-center justify-center bg-black bg-opacity-20">
                <a href="">
