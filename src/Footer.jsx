        ...
        <form action="#" className="space-y-2">
            <div className="flex flex-row items-center justify-between gap-4">
                <div className="w-full">
                    <label for="company" className="block mb-2 text-sm font-medium text-teal-200 dark:text-sky-200">Company</label>
            ...
            <div className="flex flex-row items-center justify-between gap-4 pb-6">
                <div className="w-full">
                    <label for="name" className="block mb-2 text-sm font-medium text-teal-200 dark:text-sky-200">Your name</label>
                    <Form type="text" id="name" placeholder="your name" required />
                </div>
                <div className="w-full">
                    <label for="email" className="block mb-2 text-sm font-medium text-teal-200 dark:text-sky-200">Email</label>
                    <Form type="email" id="email" placeholder="email@example.com" required />
                </div>
            </div>
            <div className="w-full">
                <label for="job-title" className="block mb-2 text-sm font-medium text-teal-200 dark:text-sky-200">Job title</label>
                <Form type="text" id="job-title" placeholder="Job title" required />
            </div>
            <div>
                <label for="salary-range" className="block mb-2 text-sm font-medium text-teal-200 dark:text-sky-200">Salary range</label>
                <div className="flex flex-col md:flex-row gap-4 w-52 md:w-96">
                    <div className="flex flex-row gap-4 items-center">
                        <p className="text-sm text-teal-200 dark:text-sky-200">From</p>
                        <Form type="text" id="from-salary" placeholder="0" required />

                    </div>
                    <div className="flex flex-row gap-4 items-center">
                        <p className="text-sm text-teal-200 dark:text-sky-200">to</p>
                        <Form type="text" id="to-salary" placeholder="99999" required />

                        <p className="text-sm text-teal-200 dark:text-sky-200">USD</p>
                    </div>
                </div>
            </div>
            <div className="sm:col-span-2 pb-6">
                <label for="message" className="block mb-2 text-sm font-medium text-teal-200 dark:text-sky-200">Job description</label>
    ...
    return (
        <footer className="bg-gradient-to-b from-teal-400 to-teal-600 text-white dark: dark:from-sky-500 dark:to-blue-500">
            ...
            <section id="social" className="flex gap-4 py-6 items-center justify-center bg-black bg-opacity-20">
                <a href="https://github.com/chermdev" target="_blank" alt="github">
                ...
                <a href="https://www.linkedin.com/in/emmanuelhdz/" target="_blank" alt="linkedin">
