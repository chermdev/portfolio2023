    ...
    return (
        <div className='hover:animate-[wiggle_0.5s_ease-in-out_infinite]'>
            <button
                ...
                <span class="group-hover:opacity-100 opacity-0 group-hover:visible invisible bg-black/70 rounded-2xl bottom-[115%] absolute text-center transition-opacity font-medium tracking-wider text-sm text-gray-100
                p-2
