...
export default function ResumeContactBtn() {
    return (
        <div className='hover:animate-[wiggle_0.5s_ease-in-out_infinite]'>
            <a
                href="https://drive.google.com/file/d/1pl2hFscsL_de1a6o6zHLBx5l-YOfhcuR"
                target='_blank'
                alt="cv"
                ...
                font-bold
                rounded-2xl
                animate-[easeIn_0.6s_ease-in-out_0.7s_both,slideFromRight_0.6s_ease-in-out_0.7s_both]
                group
                px-6
                py-1
