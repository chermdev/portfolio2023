...
function About() {
    return (
        <div className='my-16 py-12 m-auto max-w-[var(--max-page-width)] bg-white dark:bg-black bg-opacity-60 rounded-2xl px-10 flex flex-col lg:flex-row items-center justify-center gap-12'>
            <div className='overflow-hidden max-w-[50vw] max-h-[50vw] w-72 h-72 rounded-3xl animate-[ping_1s_ease-in-out_0.7s_reverse_both]'>
